...
import animationData from "../../../animations/trash/trash.json";
  ...
  render() {
    return (
      <PageCart>
        <CartSummary>
          <CartTitle>
            <CartTitleP>{"Sepetim"}</CartTitleP>
          </CartTitle>
          {/* padding-right: 450px; padding-left: 250px;*/}
          {this.props.cart.length == 0 ? (
            ...
            this.props.cart.map((cartItem) => (
              <CartItem>
                ...
                <CartPrice>
                  ₺ {cartItem.product.price},00 (x{cartItem.quantity})
                </CartPrice>
                <CartDel
                  onClick={() =>
